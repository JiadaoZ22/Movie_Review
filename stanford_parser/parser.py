...
def startJvm():
    import os
    os.environ.setdefault("STANFORD_PARSER_HOME", "/Users/jiadao/PycharmProjects/Py2/movie-review/3rdParty/stanford-parser")
    global stanford_parser_home
    stanford_parser_home = os.environ["STANFORD_PARSER_HOME"]
    jpype.startJVM(jpype.getDefaultJVMPath(),
                   "-ea",
                   "-Djava.class.path=%s/stanford-parser-2010-08-20.jar" % (stanford_parser_home),)
